...
Version 0.8.5 displays generators of the full reciprocal magnetic space group,
...
`Corresponding standard MSG Seitz operation` columns give complete Seitz pairs
in the source and standard coordinates. The latter is an abstract affine-group
correspondence, not the conventional action of a real-space MSG on Bloch
momentum. Antiunitary MSG generator names carry a prime.
