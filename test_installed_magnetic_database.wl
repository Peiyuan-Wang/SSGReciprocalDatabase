file = FileNameJoin[{DirectoryName[$InputFileName], "dist", "SSGReciprocalDatabase-0.8.5.paclet"}];
...
If[SSGReciprocalDatabaseVersion =!= {0,8,5}, Exit[2]];
...
If[rows[[1]] =!=
    {"#", "SSG generator", "MSG generator", "Antiunitary",
     "Momentum space symmetry of SSG", "Corresponding standard MSG Seitz operation"}, Exit[11]];
